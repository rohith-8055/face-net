...
images ->  
   Rohith -> 
         image_rohith_1.png -> score=0.6 --- | average = 0.65 --- |
         image_rohith_2.png -> score=0.5 ----|                    | --- output -> "Rohith"
    Vamsi ->                                                     |
         image_vamsi_1.png -> score=0.4 --- | average = 0.35 --- |
         image_vamsi_2.png -> score=0.3 ----|             
 ```
